...
public class LuceneBasicTest {

	private static final Logger logger = LoggerFactory.getLogger(LuceneBasicTest.class);
	
	private String indexPath="C:/tmp/lucene-index-directory";
	
	@Test
	public void crearIndiceFichero() throws IOException {
	...
	public void buscarEnIndice() throws ParseException, IOException {
        ...
        String queryStr1 = "búsqueda";  // Primer término de búsqueda
